...
const (
	...
	// NodeFeatureAnnotationsTacking is the annotation that holds the annotations that nfd-master set on the node
	NodeFeatureAnnotationsTacking = AnnotationNs + "/feature-annotations"
